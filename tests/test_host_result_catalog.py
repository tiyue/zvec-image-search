...
from zvec_host.result_catalog import ResultCatalog, ResultCatalogError, SearchResult


class HostResultCatalogTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_folder_pages_reuse_one_recursive_scan_until_cache_is_cleared(self) -> None:
        ...
        with mock.patch(
            "zvec_host.result_catalog._images_below",
    ...
    def test_large_manifest_is_parsed_once_then_pages_are_constant_work(self) -> None:
        ...
        with (
            ...
            mock.patch(
                "zvec_host.result_catalog._read_json_object",
