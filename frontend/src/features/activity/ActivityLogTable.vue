...
.log-action-strip{min-height:48px;padding:6px 190px 6px 2px;border-top:0;border-bottom:1px solid #e7e7e7;background:#fff}.selected-copy>strong,.job-link{color:#4b4b4b}.active-filter-chip,.details-toggle{border-color:#dedede;color:#4b4b4b;background:#ededed}
