...
.cluster-controls{align-items:center}.cluster-run-actions,.cluster-list-tools{align-self:center}
.intelligence-panel{padding:0;border:0;border-radius:0;color:#242424;background:#fff;box-shadow:none}
.intelligence-eyebrow{display:none}.intelligence-heading h2{color:#242424;font-weight:600}.intelligence-heading p:not(.intelligence-eyebrow){color:#777}
.no-cost-badge{border-color:#d8e8e1;color:#4f6d62;background:#f3faf7}
.cluster-controls{padding:10px 12px;border-color:#e5e5e5;border-radius:10px;background:#f7f7f7}
.cluster-controls select,.cluster-list-heading select{border-color:#dedede;border-radius:8px;color:#242424;background:#fff}
.cluster-type-option{border-color:#e2e2e2;border-radius:9px;background:#fff}.cluster-type-option input{accent-color:#777}
.intelligence-button{border-radius:8px;font-weight:500}.intelligence-button.primary{color:#fff;background:#606060}.intelligence-button.quiet{border-color:#dedede;color:#333;background:#f5f5f5}
.operation-status,.cluster-operation-summary,.cluster-identity-editor{border-color:#e1e1e1;color:#4b4b4b;background:#f6f6f6}
.operation-status progress{accent-color:#777}
.cluster-grid{grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}
.cluster-card{padding:6px;border:0;border-radius:10px;background:transparent;box-shadow:none}.cluster-card.selected{background:#f2f2f2}
.cluster-image-stage{border-radius:9px;background:linear-gradient(140deg,#f2f2f2,#e5e5e5)}
.cluster-type-chip,.anchor-chip{color:#555;background:#ededed}.cluster-type-chip[data-type="exact"],.cluster-type-chip[data-type="perceptual"]{color:#555;background:#ededed}
.cluster-pagination{border-top-color:#e5e5e5;color:#777}
.propagation-policy{border-color:#eadfc9;color:#6f5c3e;background:#fffaf0}
.cluster-modal{border-color:#e3e3e3;background:#fff;box-shadow:0 24px 70px rgb(0 0 0 / 18%)}
@media(max-width:1180px){.cluster-grid{grid-template-columns:repeat(3,minmax(0,1fr))}.cluster-controls{grid-template-columns:minmax(190px,.7fr) minmax(360px,1.5fr)}.cluster-run-actions{grid-column:1/-1;justify-content:flex-end}}
