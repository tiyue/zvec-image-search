...
@media(max-width:1150px){.learning-panel{height:auto;overflow:visible}.review-summary{grid-template-columns:1fr}.decision-toolbar{grid-template-columns:1fr 1fr}.edit-tag-input{grid-column:1/-1}.learning-grid{grid-template-columns:repeat(3,minmax(0,1fr));overflow:visible}.submit-review{grid-column:auto;justify-self:stretch}}
@media(max-width:760px){.learning-controls{align-items:stretch;flex-wrap:wrap}.review-summary dl{grid-template-columns:repeat(2,minmax(54px,1fr))}.decision-toolbar{grid-template-columns:1fr}.edit-tag-input,.submit-review{grid-column:auto}.learning-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
...
.learning-grid{grid-template-columns:repeat(4,minmax(0,1fr));grid-template-rows:repeat(3,minmax(280px,1fr));gap:9px;padding:2px 3px 8px 1px;align-content:stretch;overflow:auto}
.learning-card{display:grid;grid-template-columns:1fr;grid-template-rows:120px auto auto;align-items:stretch;border:1px solid #e5e5e5;border-radius:10px;background:#fff;box-shadow:none;overflow:hidden;padding:0;min-height:0}
...
.learning-image{position:relative;width:100%;height:120px;border-radius:0;background:linear-gradient(140deg,#f2f2f2,#e5e5e5);overflow:hidden}.learning-image img{width:100%;height:100%;object-fit:contain}
.learning-image>strong{right:6px;bottom:6px;width:26px;height:26px;border:0;color:#fff;background:rgb(70 70 70 / 72%)}
.learning-copy{padding:4px 8px;overflow:visible}.learning-copy>strong{font-size:11px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.learning-copy>small{color:#777;font-size:9px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.sample-kind,.reason-list,.suggested-tags{min-height:16px;display:flex;flex-wrap:wrap;gap:3px}.sample-kind span,.reason-list span,.suggested-tags span{padding:1px 5px;border-radius:999px;font-size:8px;font-weight:600}.sample-kind span{color:#536079;background:#eef1f6}.sample-kind span:first-child{color:#5547bd;background:#efedff}.reason-list span{color:#76531e;background:#fff2dc}.reason-list span[data-reason="identity_conflict"]{color:#9c3f50;background:#fff0f2}.reason-list span[data-reason="ranking_disagreement"]{color:#5547bd;background:#efedff}.suggested-tags span{color:#33705d;background:#ebf8f2}
...
@media(max-width:1180px){.learning-grid{grid-template-columns:repeat(3,minmax(0,1fr));grid-template-rows:repeat(4,minmax(280px,1fr));overflow:auto}}
...
.learning-feedback{display:grid;gap:7px}.review-summary{border-color:#e1e1e1!important;border-radius:8px!important;color:#555!important;background:#f6f6f6!important}
...
.learning-empty{display:grid;min-height:0;place-items:center;align-content:center;color:#777}.learning-empty strong{font-weight:500}.learning-empty span{margin-top:4px;font-size:11px}.learning-grid{grid-template-columns:repeat(4,minmax(0,1fr));grid-template-rows:repeat(3,minmax(280px,1fr));gap:9px;padding:2px 3px 8px 1px;align-content:stretch;overflow:auto}
</style>
