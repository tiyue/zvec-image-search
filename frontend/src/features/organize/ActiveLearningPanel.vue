...
function setupGridObserver(el: HTMLElement): void {
  updateContainerWidth();
...
@media(max-width:1550px){.learning-grid{grid-template-columns:repeat(2,1fr);grid-auto-flow:row dense;grid-auto-rows:10px;overflow:auto}.decision-toolbar{grid-template-columns:auto auto minmax(220px,1fr) auto}.submit-review{grid-column:1/-1;justify-self:end}}
...
@media(max-width:760px){.learning-controls{align-items:stretch;flex-wrap:wrap}.review-summary dl{grid-template-columns:repeat(2,minmax(54px,1fr))}.decision-toolbar{grid-template-columns:1fr}.edit-tag-input,.submit-review{grid-column:auto}.learning-grid{grid-template-columns:repeat(2,1fr);grid-auto-flow:row dense;grid-auto-rows:10px;overflow:auto}}
@media(max-width:500px){.learning-grid{grid-template-columns:1fr;grid-auto-flow:row dense;grid-auto-rows:10px;overflow:auto}}
...
.learning-grid{grid-template-columns:repeat(2,1fr);grid-auto-flow:row dense;grid-auto-rows:10px;gap:8px;overflow:auto;padding:2px 3px 8px 1px}
...
.learning-empty{display:grid;min-height:0;place-items:center;align-content:center;color:#777}.learning-empty strong{font-weight:500}.learning-empty span{margin-top:4px;font-size:11px}.learning-grid{grid-template-columns:repeat(2,1fr);grid-auto-flow:row dense;grid-auto-rows:10px;gap:8px;overflow:auto;padding:2px 3px 8px 1px}.learning-card.span-2{grid-column:span 2}
