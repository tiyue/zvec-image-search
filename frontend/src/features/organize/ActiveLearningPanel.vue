...
import { gridSpan } from "./galleryCapacity";
import type {
  IntelligenceImage,
...
.learning-grid{grid-template-columns:repeat(2,1fr);grid-auto-flow:row dense;grid-auto-rows:1fr;gap:8px;padding:2px 3px 8px 1px;overflow:auto}
...
@media(max-width:1180px){.learning-grid{grid-template-columns:repeat(2,1fr);grid-auto-flow:row dense;grid-auto-rows:1fr;overflow:auto}}
@media(max-width:760px){.learning-grid{grid-template-columns:repeat(2,1fr);grid-auto-flow:row dense;grid-auto-rows:1fr;overflow:auto}.learning-notice{flex-wrap:wrap}.learning-notice .learning-controls{width:100%}}
