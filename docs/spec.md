...
> 版本：0.1.1（机器 SemVer：0.1.1）| 最后更新：2026-07-29
...
- **安卓端**：Gradle 构建 .apk
- **发布版本**：机器版本 `0.1.1`，公开展示版本 `0.1.1`，稳定标签 `v0.1.1`
- **Windows 版本资源**：发布载荷内三个可执行文件的产品名均为 `YaoLens`，文件版本与产品版本均展示为 `0.1.1`，固定数值版本为 `0.1.1.0`
- **发布矩阵**：仅发布 YaoLens Windows、Android 及对应校验、验证报告和策略元数据
- **公开附件**：`YaoLens-0.1.1-win-x64-portable.zip`、`YaoLens-0.1.1-win-x64-setup.exe`、`YaoLens-0.1.1-android.apk`
