...
YaoLens 0.5 使用机器版本 `0.5.0`，公开展示版本为 `0.5`，稳定标签为
`v0.5.0`。GitHub Release 只交付 Windows x64、Android，以及对应的校验和、
...
- 版本为 `0.5.0`，标签为 `v0.5.0`，且标签精确指向工作流提交。
- GitHub Release 标题为 `YaoLens 0.5`。
- Release 不使用草稿或预发布参数。
