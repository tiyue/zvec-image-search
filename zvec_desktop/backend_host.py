"""Pure-Python lifecycle host for the persistent native backend.

The desktop process owns only a generated runtime manifest and query-staging
...
class BackendHost:
    ...
    desktop uses the sibling ``zvec-backend`` executable that shares its bundled
    runtime without routing backend work back through the GUI executable.
    """
    ...
    def session_token(self) -> str | None:
        """Return the in-memory token needed by trusted desktop components."""
