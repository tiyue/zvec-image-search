"""Secure API-key storage for the local application host.

On Windows this module uses the established Generic Credential target so an
upgrade can reuse the saved DashScope key without
